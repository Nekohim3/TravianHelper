...
namespace TravianHelper.JsonDb
{
    internal static class ObjectExtensions
    {
        ...
        internal static dynamic GetDefaultValue<T>(string fieldName)
        {
            ...
            if (idProp.PropertyType.IsValueType) return Activator.CreateInstance(idProp.PropertyType);
            if (idProp.PropertyType == typeof(string)) return "0";
            return null;
        }
